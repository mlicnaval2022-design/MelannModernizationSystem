...
if not errorlevel 1 (
  ...
  echo ======================================================
  echo.
  if /I not "%MLS_NO_BROWSER%"=="1" start "" "https://localhost:%PORT%/login?fix=favicon-v5"
...
echo   MELANN LENDING SYSTEM - SERVER
echo ======================================================
echo   Server PC:  https://localhost:%PORT%
echo   Client URL: https://%COMPUTERNAME%:%PORT%
echo   IP fallback: https://%SERVER_IP%:%PORT%
echo ======================================================
echo.
