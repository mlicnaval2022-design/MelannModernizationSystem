...
export default function PromissoryDisclosure() {
  ...
  const filteredLoans = useMemo(() => {
    const dateFiltered = releaseDate
      ? loans.filter(loan => {
          return String(loan.date_released || '').slice(0, 10) === releaseDate;
        })
      : loans
    ...
    <div className="index-preview-shell">
      <style>{`
        ...
        @media print {
          ...
          #index-printable { position: absolute !important; left: 0 !important; top: 0 !important; width: 8in !important; height: 5in !important; margin: 0 !important; box-shadow: none !important; overflow: hidden !important; transform: none !important; zoom: 1 !important; }
          * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
        }
      `}</style>
