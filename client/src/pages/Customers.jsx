            ...
            <div className="modal-body" style={{ padding: '30px', background: '#f8fafc' }} id="printable-area">
              {soaLoading ? <div className="text-center" style={{ padding: 40 }}>Loading SOA Data...</div> : soaData ? (() => {
                ...
                const profileSections = [
                  ...
                  { title: 'Business Information', fields: [['Business Type', soaData.business_type], ['Occupation', soaData.occupation], ['Business Name', soaData.business_name], ['Monthly Income', soaData.income_per_month ? `PHP ${Number(soaData.income_per_month).toLocaleString(undefined, {minimumFractionDigits:2})}` : ''], ['Monthly Expense', soaData.expenses_per_month ? `PHP ${Number(soaData.expenses_per_month).toLocaleString(undefined, {minimumFractionDigits:2})}` : ''], ['Loan Purpose', soaData.loan_purpose], ['Collateral', soaData.collateral], ['Branch', soaData.branch_name], ['Collector', soaData.collector_name]] },
