      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderBottom: '2px solid #e2e8f0', marginBottom: '20px' }}>
        ...
        {active !== 'CIC' && (
          <div style={{ display: 'flex', gap: 8, marginBottom: 4 }}>
            <button className={`btn btn-sm ${viewMode === 'company' ? 'btn-primary' : 'btn-secondary'}`} onClick={() => setViewMode('company')}>Company Compliance</button>
            <button className={`btn btn-sm ${viewMode === 'clients' ? 'btn-primary' : 'btn-secondary'}`} onClick={() => setViewMode('clients')}>Client Reports</button>
          </div>
        )}
      </div>
...
>>>>>>> df687878bf4058b86ca94a86b40c8634518d7394
